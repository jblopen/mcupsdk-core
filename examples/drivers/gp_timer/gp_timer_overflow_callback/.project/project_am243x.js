...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_GP_TIMER_OVERFLOW_CALLBACK";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "gp_timer_overflow_callback_main",
        },
    },
];
...
const buildOptionCombos_threadx = [
    { device: device, cpu: "r5fss0-0", cgt: "ti-arm-clang", board: "am243x-evm", os: "threax"},
    { device: device, cpu: "r5fss0-0", cgt: "ti-arm-clang", board: "am243x-lp", os: "threax"},
];
...
function getComponentProperty(device) {
    ...
    property.name = "gp_timer_overflow_callback";
    property.isInternal = false;
    property.description = "A GPTIMER Example. This example Runs the Timer with interrupt enabled and Triggers a Overflow Callback."

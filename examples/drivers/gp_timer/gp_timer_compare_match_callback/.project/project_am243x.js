...
const files = {
    common: [
        "gp_timer_compare_match_callback.c",
        "main.c",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_GP_TIMER_COMPARE_MATCH_CALLBACK";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "gp_timer_compare_match_callback_main",
        },
    },
];
...
function getComponentProperty(device) {
    ...
    property.name = "gp_timer_compare_match_callback";
    property.isInternal = false;
    property.description = "A GPTIMER Example. This example Runs the Timer in Compare match mode and triggers a callback on match."

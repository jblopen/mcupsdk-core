...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_GP_TIMER_PWM_CAPTURE";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "gp_timer_pwm_capture_main",
        },
    },
];
...
function getComponentProperty(device) {
    ...
    property.name = "gp_timer_pwm_capture";
    property.isInternal = false;
    property.description = "A GPTIMER Example. This example runs a timer in pwm generation mode and captures using another timer."

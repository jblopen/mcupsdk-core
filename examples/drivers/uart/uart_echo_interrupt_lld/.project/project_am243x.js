...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_UART_ECHO_INTERRUPT_LLD";
...
[
    ...
    },
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "uart_echo_interrupt_lld",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "uart_echo_interrupt_lld";

...
const files = {
    common: [
        "mcspi_loopback_interrupt_lld.c",
        "main.c",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_MCSPI_LOOPBACK_INTERRUPT_LLD";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "mcspi_loopback_interrupt_lld_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "mcspi_loopback_interrupt_lld";

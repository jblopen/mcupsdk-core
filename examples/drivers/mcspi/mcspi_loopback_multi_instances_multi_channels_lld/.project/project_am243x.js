...
const files = {
    common: [
        "mcspi_loopback_multi_instances_multi_channels_lld.c",
        "main.c",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_MCSPI_LOOPBACK_MULTIPLE_INSTANCES_MULTIPLE_CHANNELS_LLD";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "mcspi_loopback_multi_instances_multi_channels_lld_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "mcspi_loopback_multi_instances_multi_channels_lld";

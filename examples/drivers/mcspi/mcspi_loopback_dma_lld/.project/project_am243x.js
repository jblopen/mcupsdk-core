...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_MCSPI_LOOPBACK_DMA_LLD";
...
[
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "mcspi_loopback_dma_lld_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "mcspi_loopback_dma_lld";

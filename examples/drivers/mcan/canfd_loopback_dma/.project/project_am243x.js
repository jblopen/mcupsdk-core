...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_CANFD_LOOPBACK_DMA";
...
[
    ...
    },
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "canfd_loopback_dma_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "canfd_loopback_dma";
